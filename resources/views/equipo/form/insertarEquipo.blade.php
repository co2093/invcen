                    ...
                    <div class="row" width="100%">
                        ...
                        <div class="form-group col-md-12">
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="especifico" name="especifico">         
                          </div>
                        </div>    
                        <div class="form-group col-md-12">
                          <div class="input-group">
                        ...
                        <div class="form-group col-md-12">
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control datepicker2" data-date-format="dd-mm-yyyy" id="fecha_adquisicion" name="fecha_adquisicion">         
                          </div>
                        </div>
                        <div class="form-group col-md-12">
                          <div class="input-group">
