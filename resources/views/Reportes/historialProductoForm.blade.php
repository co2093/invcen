    ...
    <div class="panel panel-info">
        <div class="panel-heading" role="tab">
            <h2 class="panel-title">
                <strong>Reporte: Historial del producto</strong>
            </h2>
        </div>
        <div class="panel-body">


            {!! Form::open(array('route' => 'reportes.historialproducto','class' => 'form-horizontal','method' => 'get')) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <select name="producto" class="form-control js-example-basic-single js-example-responsive" style="width: 100%">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    ...
                    <div class="error">
                        <ul>@foreach($errors->get('fechainicio') as $msg)<li>{{$msg}}</li> @endforeach</ul>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-7">
                    ...
                    <div class="error">
                        <ul>@foreach($errors->get('fechafin') as $msg)<li>{{$msg}}</li> @endforeach</ul>
                    </div>
                </div>
            </div>
