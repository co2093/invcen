        ...
        <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12 margen text-center">
                ...
                <a href="{{ route('reporte_kardexform')}}" class="color" target="_blank">
                    <img src="{{asset('dist/img/pdf_report.png')}}" alt="imagen" class="img-responsive img-rounded" />
                    <h3>Kardex</h3>
                </a>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12 margen text-center">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 margen text-center">
                ...
                <a href="#" class="color" target="_blank">
                    <img src="{{asset('dist/img/excel_report.png')}}" alt="imagen" class="img-responsive img-rounded" />
