...
@section('content')
    ...
    <div class="panel-body table-responsive">
        ...
        <div class="box-header with-border">
            <h3 class="box-title">¿Esta seguro que desea que el administrador de bodega vuelva a editar la solicitud?</h3>
        </div><!-- /.box-header -->
        <!-- form start -->
        <div class="form-horizontal">
            {!!Form::open(['route'=>['volver-editar',$requisicion->id],'method'=>'post'])!!}
            {{ csrf_field() }}
